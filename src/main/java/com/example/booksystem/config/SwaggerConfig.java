...
public class SwaggerConfig {
    ...
    private static final String title = "Books Management System REST API";
    private static final String description = "Restful API for BMS";
